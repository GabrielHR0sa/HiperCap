...
begin
  FR.Clear; // Limpa qualquer conteúdo anterior do relatório
  FR.LoadFromFile(CaminhoRelat); // Carrega o relatório a partir do arquivo especificado
  FR.DesignReport; // Abre o designer para edição
end;
